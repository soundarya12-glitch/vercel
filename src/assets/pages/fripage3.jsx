...
export default function Frictionthree() {
  const [open, setOpen] = useState(false);
  const navigate = useNavigate();

  const books = [
     { title: 'Powerless', image: '/power.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 4 },
    { title: 'The Kite Runner', image: '/runner.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 5 },
    { title: 'The Games', image: '/hunger.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 3 },
    { title: 'Marvel Avengers Alliance', image: '/avg.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 4 },
     { title: 'The slave', image: '/slave.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 4 },
    { title: 'Digital Fortress', image: '/dan.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 5 },
    { title: 'Ender’s Game', image: '/game.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 3 },
    { title: 'The dan brown', image: '/brown.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 4 },
            ...
            <div className="absolute mt-2 w-full bg-white border border-gray-200 rounded shadow-lg z-50">
              <ul className="py-1 text-sm text-gray-700">
                {[
                  ...
                  { text: "Non-Fiction", path: "/nonfiction" },
