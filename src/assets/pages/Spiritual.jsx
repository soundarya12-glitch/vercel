...
export default function Spiritual() {
  ...
  const books = [
    { title: 'The Midnight Library', image: '/midnight.jpg', link: '/cart', rating: 4, Author: "Author-name kilopara", button: 'BUY NOW' },
    ...
    { title: 'The Psychology of Money', image: '/fiction.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 4 },
    { title: 'Educated', image: '/fantasy.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 5 },
    { title: 'Ikigai', image: '/business.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 3 },
    { title: 'Think Like a Monk', image: '/romance.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 4 },
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <aside className="w-full lg:w-64 bg-white p-4 shadow-md">
        <h2 className="text-xl font-semibold mb-4">Spirtual</h2>
        ...
        <div className="mb-5">
          ...
          <ul className="space-y-1">
            {["All Books", "Children Books", "Fiction","All Books", "Children Books", "Fiction","All Books", "Children Books",].map((cat, i) => (
