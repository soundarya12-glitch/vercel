...
export default function Frictiontwo() {
  ...
  const books = [
     { title: 'The Slient Patient', image: '/patient.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 4 },
    { title: 'The Martin', image: '/19.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 5 },
    { title: 'Matched', image: '/match.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 3 },
    { title: 'Think Like a Monk', image: '/def.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 4 },
    { title: 'Twisted Love', image: '/love.jpg', link: '/cart', rating: 4, Author: "Author-name kilopara", button: 'BUY NOW' },
    { title: 'The pillars of Earth', image: '/pillars.jpg', link: '/cart', Author: "Author-name kilopara", rating: 5, button: 'BUY NOW' },
    { title: 'Broken', image: '/code.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 4 },
    { title: 'Enga pokiral', image: '/macroon.jpg', link: '/cart', Author: "Author-name kilopara", button: 'BUY NOW', rating: 5 },
            ...
            <div className="absolute mt-2 w-full bg-white border border-gray-200 rounded shadow-lg z-50">
              <ul className="py-1 text-sm text-gray-700">
                {[
                  ...
                  { text: "Combos & Box Sets", path: "/category/combo" },
                  { text: "Blog", path: "/category/blog" }
                ].map((item, idx) => (
                  <li key={idx}>
   ...
   <NavLink
        ...
        className={({ isActive }) =>
          `px-3 py-2 bg-blue-500 text-white rounded ${
            isActive ? "bg-indigo-200 text-blue-800 font-semibold" : "hover:bg-indigo-500"
          }`
        }
      >
        1
        ...
        to="/fripage2"
        className={({ isActive }) =>
          `px-3 py-2 bg-indigo-500 text-white rounded ${
            isActive ? "bg-blue-500 text-blue-800 font-semibold" : "hover:bg-indigo-500"
          }`
        }
      >
        2
