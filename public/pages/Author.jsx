...
const images = [
  { src: '/Author1.jpg', title: 'Fiction', link: '/Reg ' },
  { src: '/Author2.jpg', title: 'Romance', link: '/books/romance' },
  { src: '/Author3.jpg', title: 'Mystery', link: '/books/mystery' },
  { src:  '/Author4.jpg', title: 'Sci-Fi', link: '/books/scifi' },
  { src: '/Author5.jpg', title: 'Self Help', link: '/books/selfhelp' },
  { src: '/Author6.jpg', title: 'History', link: '/books/history' },
  ...
  return (
    <div className="w-full px-4 py-6">
      <h2 className="text-3xl font-bold mb-6 text-gray-800 text-left">
        Best selling Non friction books
      </h2>
